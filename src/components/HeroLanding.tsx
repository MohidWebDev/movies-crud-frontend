...
export const HeroLanding: React.FC<HeroLandingProps> = ({ onViewMovies }) => {
  return (
    <div id="hero-landing-page" className="w-full">
      {/* Hero Section — exactly one viewport height minus the navbar */}
      <div className="relative min-h-[calc(100vh-5rem)] w-full flex flex-col justify-center items-center px-4 sm:px-6 lg:px-8 overflow-hidden bg-[radial-gradient(ellipse_at_top,var(--tw-gradient-stops))] from-red-900/20 via-zinc-950 to-black py-6 sm:py-10">
